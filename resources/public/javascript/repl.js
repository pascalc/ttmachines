...
ttmachines.client.repl.map__GT_js = function(a) {
...
ttmachines.client.repl.go_compile = function(a) {
  var b = cljs.core.atom.call(null, null), a = ttmachines.client.repl.map__GT_js.call(null, cljs.core.ObjMap.fromObject("\ufdd0'url,\ufdd0'data,\ufdd0'contentType,\ufdd0'async,\ufdd0'type,\ufdd0'dataType,\ufdd0'success".split(","), {"\ufdd0'url":"/compile", "\ufdd0'data":cljs.core.str.call(null, "{:expr ", a, "}"), "\ufdd0'contentType":"application/clojure; charset=utf-8", "\ufdd0'async":!1, "\ufdd0'type":"POST", "\ufdd0'dataType":"text", "\ufdd0'success":function(a) {
...
ttmachines.client.repl.codemirrorify = function(a, b) {
  return CodeMirror.fromTextArea(document.getElementById(a), ttmachines.client.repl.map__GT_js.call(null, b))
};
ttmachines.client.repl.make_editor = function() {
  return ttmachines.client.repl.codemirrorify.call(null, "editor-textarea", cljs.core.ObjMap.fromObject(["\ufdd0'theme", "\ufdd0'lineNumbers", "\ufdd0'matchBrackets"], {"\ufdd0'theme":"ambiance", "\ufdd0'lineNumbers":!0, "\ufdd0'matchBrackets":!0}))
};
ttmachines.client.repl.make_result = function() {
  return ttmachines.client.repl.codemirrorify.call(null, "result-textarea", cljs.core.ObjMap.fromObject(["\ufdd0'theme", "\ufdd0'readOnly", "\ufdd0'lineWrapping"], {"\ufdd0'theme":"ambiance", "\ufdd0'readOnly":!0, "\ufdd0'lineWrapping":!0}))
};
...
ttmachines.client.repl.show_result = function(a, b) {
  return a.setValue(cljs.core.pr_str.call(null, b))
};
ttmachines.client.repl.process = function(a, b) {
  var c = ttmachines.client.repl.pre_compile.call(null, a), c = ttmachines.client.repl.evaluate.call(null, c);
  return ttmachines.client.repl.show_result.call(null, b, c)
};
ttmachines.client.repl.get_doc = function(a) {
  cljs.core.atom.call(null, null);
  a = ttmachines.client.repl.map__GT_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'url", "\ufdd0'async", "\ufdd0'type", "\ufdd0'success"], {"\ufdd0'url":cljs.core.str.call(null, "/doc/", a), "\ufdd0'async":!0, "\ufdd0'type":"GET", "\ufdd0'success":function(a) {
...
ttmachines.client.repl.setup = function() {
  var a = ttmachines.client.repl.make_editor.call(null), b = ttmachines.client.repl.make_result.call(null), c = cljs.core.atom.call(null, a.getValue());
  cljs.core.set_validator_BANG_.call(null, c, ttmachines.client.repl.valid_code);
  cljs.core.add_watch.call(null, c, "\ufdd0'process", function(a, c, f, g) {
